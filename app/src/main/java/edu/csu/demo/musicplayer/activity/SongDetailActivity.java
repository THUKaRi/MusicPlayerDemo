...
import edu.csu.demo.musicplayer.myView.GramophoneView;
...
public class SongDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        if(current_status == MusicService.STATUS_PLAYING){
            play_pause_action.setImageDrawable(getResources().getDrawable(R.drawable.pause));
        }else{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (current_status) {
                ...
                case MusicService.STATUS_PLAYING:
                    ...
                    //更新UI
                    play_pause_action.setImageDrawable(getDrawable(R.drawable.pause));//改变图标
                    seekBar.setMax(duration);
                    duration_text.setText(durationToString(duration));
                ...
                //播放器状态更改为暂停
                case MusicService.STATUS_PAUSED:
                    play_pause_action.setImageDrawable(getDrawable(R.drawable.play));
